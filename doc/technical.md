...
- 游戏：Bubble Wrap, Eternal
- 类型：casual
- 简述：Endless bubble wrap. Tap to pop — pitch-randomized chirp, a satisfying splash, the next row already calling. Every 8th pop drops a deadpan paper fortune that joins Today's Slips wall. AlterU sensory.
...
- 平台元信息：meta.title=Bubble Wrap, Eternal；cover_url=/poster.png；category=casual；uuid=04035b6c-aea7-4635-8302-3bf1a1870871
...
- `src/Bubbles/types.ts`
- `src/Bubbles/Bubbles.less`
- `src/Bubbles/index.ts`
- `src/Bubbles/Bubbles.tsx`
- `src/Bubbles/utils/audio.ts`
- `src/Bubbles/utils/prompts.ts`
